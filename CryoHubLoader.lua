...
local CryoHubLoader = Instance.new("ScreenGui")
...
-- Properties:
CryoHubLoader.Name = "CryoHubLoader"
CryoHubLoader.Parent = game.CoreGui

Main_1.Name = "Main"
Main_1.Parent = CryoHubLoader
...
CryoHubLogo_1.Parent = LogoAndTitleHolder_1
...
CryoHubLogo_1.Position = UDim2.new(0.185223803, 0,0.454545468, 0)
CryoHubLogo_1.Size = UDim2.new(0, 34,0, 34)
...
wait(2)
StatusTween3:Play()
if game.PlaceId == 3101667897 or game.PlaceId == 3956818381 or game.PlaceId == 5317063266 then -- Legends Of Speed PlaceIds
	Status_1.Text = "Game Supported"
	wait(2)
	StatusTween4:Play()
	Status_1.Text = "Loading Cryo Hub"
	wait(2)
	ItemsHolder_1.Visible = false
	TitleHolder_1.Visible = false
	...
	wait(0.3)
	Main_1.Visible = false
	-- Legends Of Speed Loadstring here
else
